...
export default function StudentMentorsPage() {
  ...
  const mentors = [
    ...
    },
    {
      id: 4,
      name: "Emily Davis",
      avatar: "https://images.unsplash.com/photo-1519345182560-3f2917c472ef?w=400&h=400&fit=crop&crop=face&auto=format",
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-start space-x-4">
                <div className="relative">
                  <div className="w-16 h-16 bg-gradient-to-br rounded-full flex items-center justify-center text-white font-semibold text-lg">
                    <img src={mentor.avatar} alt={mentor.name} className="w-full h-full rounded-full" />
                  </div>
                  {mentor.isOnline && (
